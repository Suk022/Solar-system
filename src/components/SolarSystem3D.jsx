    ...
    <>
      {showInfo && hoveredPlanet && !isSidebarOpen && (
        <div style={infoCardStyle}>
          ...
          <div>
            <b>Distance from Sun:</b> {hoveredPlanet.distanceFromSun.km} million
            km ({hoveredPlanet.distanceFromSun.au} AU)
          </div>
          <div>
            <b>Orbital Period:</b> {hoveredPlanet.orbitalPeriod} days
          </div>
          <div>
            <b>Number of Moons:</b> {hoveredPlanet.numMoons}
          </div>
          <div>
            <b>Surface Temp:</b> {hoveredPlanet.surfaceTemp.c}°C /{" "}
            {hoveredPlanet.surfaceTemp.k}K
          </div>
      ...
      >
        ...
        <Background />
        <Sun
          onClick={() => onPlanetClick(planets.find((p) => p.name === "Sun"))}
        />
        {/* Planets */}
        {planets
          .filter((p) => p.name !== "Sun")
