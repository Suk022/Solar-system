...
const modalContentStyle = {
  background:
    "linear-gradient(180deg,rgb(20, 20, 20) 90%,rgb(24, 24, 26) 100%)",
  color: "#fff",
  borderRadius: "16px",
  marginTop: "3.50rem",
...
const DWARF_PLANETS = [
  ...
  {
    name: "Haumea",
    url: "https://solarsystem.nasa.gov/planets/dwarf-planets/haumea/overview/",
  },
  {
    name: "Makemake",
    url: "https://solarsystem.nasa.gov/planets/dwarf-planets/makemake/overview/",
  },
  {
    name: "Ceres",
    url: "https://solarsystem.nasa.gov/planets/dwarf-planets/ceres/overview/",
  },
...
const COMETS = [
  {
    name: "Halley",
    url: "https://solarsystem.nasa.gov/asteroids-comets-and-meteors/comets/1p-halley/in-depth/",
  },
...
const SPACECRAFT = [
  ...
  {
    name: "Lucy",
    url: "https://www.nasa.gov/mission_pages/lucy/main/index.html",
  },
          ...
          {expanded ? (
            <>
              ...
              <div style={{ display: "flex", gap: 32 }}>
                {expandedData.map((group) => (
                  <div
                    key={group.label}
                    style={{ flex: 1, minWidth: 180, marginRight: 32 }}
                  >
                    <div
                      style={{
                        ...sectionTitleStyle,
            ...
            <div style={rowStyle}>
              <div style={colStyle}>
                ...
                <div style={viewMoreStyle} onClick={() => setExpanded("dwarf")}>
                  View More
                </div>
              </div>
              <div style={colStyle}>
              ...
              <div style={colStyle}>
                ...
                <div
                  style={viewMoreStyle}
                  onClick={() => setExpanded("spacecraft")}
                >
                  View More
                </div>
              </div>
