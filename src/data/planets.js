...
const planets = [
  {
    ...
    funFact:
      "The Sun's energy output in one second is equal to 1 trillion megaton bombs!",
    ...
    culturalImpact: {
      ancientCultures:
        "Worshipped as a deity in many ancient cultures - Ra in Egyptian mythology, Helios in Greek mythology, Surya in Hindu mythology, and Amaterasu in Japanese mythology",
      mythology:
        "The Sun has been central to human mythology and religion throughout history, representing life, power, and divine authority",
      symbolism:
        "Universal symbol of life, power, time, and renewal across cultures and civilizations",
      scientificSignificance:
        "Understanding the Sun is crucial for space weather prediction and protecting Earth's technology and astronauts",
    },
  },
  {
    name: "Mercury",
    ...
    funFact:
      "A day on Mercury is longer than its year! One solar day (sunrise to sunrise) on Mercury is 176 Earth days.",
    physicalCharacteristics: {
      diameter: "4,879 km",
      mass: "3.30 × 10²³ kg",
      gravity: "3.7 m/s²",
    ...
    internalStructure: {
      ...
      details:
        "The core is surprisingly large and partially molten, generating a weak magnetic field.",
    },
    exploration: {
      missions: ["Mariner 10", "MESSENGER", "BepiColombo"],
      discoveries:
        "Water ice in permanently shadowed polar craters, and a surprising magnetic field.",
    },
    culturalImpact: {
      ancientCultures:
        "Named for the Roman messenger god, Mercury was known to ancient civilizations and observed for millennia",
      mythology:
        "In Roman mythology, Mercury was the messenger of the gods, associated with communication, travel, and commerce. In Greek mythology, he was known as Hermes",
      symbolism:
        "Associated with speed, communication, intellect, and swiftness due to its rapid orbit around the Sun",
      scienceFiction:
        "Often featured in science fiction, typically as a planet with extreme temperature variations and a base for solar research",
      scientificSignificance:
        "Studying Mercury helps scientists understand planetary formation and the history of the inner solar system, particularly how planets respond to intense solar radiation",
    },
  },
  {
    name: "Venus",
    ...
    culturalImpact: {
      ancientCultures:
        "Known since antiquity as the 'morning star' and 'evening star', it was named after the Roman goddess of love and beauty",
      mythology:
        "In Roman mythology, Venus was the goddess of love, beauty, and fertility. In Greek mythology, she was known as Aphrodite. Many cultures associated Venus with femininity and romance",
      symbolism:
        "Symbol of love, beauty, and femininity across many cultures. Its brightness made it one of the most important celestial objects in ancient astronomy",
      scienceFiction:
        "A frequent subject in science fiction, often depicted before the 20th century as a tropical paradise, a view shattered by the discovery of its true hellish environment",
      scientificSignificance:
        "Its extreme greenhouse effect serves as a critical case study for understanding climate change on Earth",
    },
  },
  {
    name: "Earth",
    ...
    atmosphere: {
      composition:
        "Nitrogen (78.08%), Oxygen (20.95%), Argon (0.93%), Carbon Dioxide (0.04%), with traces of other gases",
    ...
    surface: {
      features:
        "71% covered by oceans, 29% land including continents, islands, mountains, deserts, and polar ice caps",
    ...
    internalStructure: {
      ...
      details:
        "Only planet with active plate tectonics, which recycle the crust and create mountains, volcanoes, and earthquakes",
      magneticField:
    ...
    exploration: {
      ...
      discoveries:
        "Ozone layer depletion and recovery, climate change patterns, ocean circulation, atmospheric composition changes",
      spacePrograms: "NASA, ESA, Roscosmos, CNSA, ISRO, JAXA",
    },
    culturalImpact: {
      ancientCultures:
        "Known as Gaia in Greek mythology, Terra in Roman mythology, and revered as Mother Earth in many indigenous cultures",
      mythology:
        "In Greek mythology, Gaia was the primordial goddess of Earth, mother of all life. In Roman mythology, Terra was the goddess of the Earth. Many cultures personify Earth as a nurturing mother figure",
      symbolism:
        "Universal symbol of home, life, and fertility. Often represented as a mother figure nurturing all living things",
      scienceFiction:
        "Often depicted as the cradle of humanity and a paradise compared to other worlds in science fiction",
      scientificSignificance:
        "Serves as the baseline for understanding other planets and the search for extraterrestrial life",
    },
  },
  {
    name: "Mars",
    ...
    atmosphere: {
      composition:
        "Carbon Dioxide (95.3%), Nitrogen (2.7%), Argon (1.6%), with traces of oxygen, carbon monoxide, and water vapor",
    ...
    surface: {
      features:
        "Olympus Mons (largest volcano), Valles Marineris (largest canyon), polar ice caps, impact craters, sand dunes, ancient river valleys",
    ...
    internalStructure: {
      ...
      details:
        "Core is likely partially molten, generating a weak magnetic field",
      magneticField:
        "Weak, patchy magnetic field suggesting the core may have cooled significantly",
    },
    exploration: {
      missions: [
        "Perseverance",
      ...
      discoveries:
        "Evidence of past liquid water, organic molecules, seasonal methane releases, ancient river deltas",
      futureMissions:
        "Planned human missions, sample return missions, and continued robotic exploration",
    },
    culturalImpact: {
      ancientCultures:
        "Named after the Roman god of war due to its red color, associated with blood and conflict",
      mythology:
        "In Roman mythology, Mars was the god of war, agriculture, and fertility. In Greek mythology, he was known as Ares. The planet's red color reminded ancient observers of blood and warfare",
      symbolism:
        "Symbol of war, aggression, and masculine energy. Its red color has been associated with blood, fire, and conflict throughout history",
      scienceFiction:
        "A popular setting in science fiction, from H.G. Wells' 'War of the Worlds' to modern films like 'The Martian'",
      scientificSignificance:
        "Key target for astrobiology research and potential future human colonization",
    },
  },
  {
    name: "Jupiter",
    ...
    distanceFromSun: { km: 778.5, au: 5.2 },
    orbitalPeriod: 4333,
    numMoons: 95,
    ...
    atmosphere: {
      composition:
        "Hydrogen (90%), Helium (10%), with traces of methane, ammonia, water vapor, and other compounds",
      pressure: "No solid surface, pressure increases with depth",
      layers: "Upper atmosphere, troposphere, stratosphere, thermosphere",
      bands:
        "Alternating light and dark bands caused by different wind speeds and directions",
    },
    surface: {
      features:
        "Colorful bands, Great Red Spot, white ovals, brown barges, no solid surface",
      temperature: "-110°C (cloud top level)",
      storms:
        "Numerous storms including the Great Red Spot, white ovals, and brown barges",
      cloudLayers:
        "Multiple cloud layers at different altitudes with different compositions",
    },
    internalStructure: {
      core: "Rocky core (possibly 10-15 Earth masses), surrounded by metallic hydrogen, then liquid hydrogen",
      details:
        "No solid surface, gradually transitions from gas to liquid to metallic hydrogen with depth",
      magneticField:
        "Generated by the movement of metallic hydrogen in the outer core",
    },
    exploration: {
      missions: ["Voyager 1 & 2", "Galileo", "Juno", "Cassini", "New Horizons"],
      discoveries:
        "Complex atmospheric dynamics, powerful magnetic field, volcanic activity on Io, subsurface ocean on Europa",
      currentMission:
        "Juno spacecraft studying Jupiter's atmosphere, magnetic field, and internal structure",
    },
    culturalImpact: {
      ancientCultures:
        "Named after the Roman king of the gods, Jupiter was known to ancient civilizations and associated with power and authority",
      mythology:
        "In Roman mythology, Jupiter was the king of the gods, ruler of the sky and thunder. In Greek mythology, he was known as Zeus. He was associated with justice, law, and divine authority",
      symbolism:
        "Symbol of power, authority, and divine kingship. Its size and brightness made it a prominent symbol of strength and leadership",
      scienceFiction:
        "Frequently featured in science fiction as a gas giant with floating cities or as a backdrop for space adventures",
      scientificSignificance:
        "Studying Jupiter helps scientists understand gas giant formation and the early solar system",
    },
  },
  {
    name: "Saturn",
    ...
    atmosphere: {
      composition:
        "Hydrogen (96.3%), Helium (3.25%), with traces of methane, ammonia, and other compounds",
      pressure: "No solid surface, pressure increases with depth",
      layers: "Upper atmosphere, troposphere, stratosphere, thermosphere",
    ...
    surface: {
      features:
        "Spectacular ring system, hexagonal polar storm, no solid surface",
      temperature: "-178°C (cloud top level)",
      storms: "Hexagonal storm at north pole, occasional storms in atmosphere",
      cloudLayers:
        "Multiple cloud layers similar to Jupiter but less prominent",
    },
    internalStructure: {
      core: "Rocky core, surrounded by liquid metallic hydrogen, then liquid hydrogen",
      details:
        "Similar structure to Jupiter but less massive, no solid surface",
      magneticField:
        "Generated by the movement of metallic hydrogen in the outer core",
    },
    exploration: {
      ...
      discoveries:
        "Complex ring structure, lakes of liquid methane on Titan, subsurface ocean on Enceladus",
      cassiniLegacy:
        "Cassini mission provided unprecedented views of Saturn's rings and moons over 13 years",
    },
    culturalImpact: {
      ancientCultures:
        "Named after the Roman god of agriculture and time, Saturn was associated with harvest and the passage of time",
      mythology:
        "In Roman mythology, Saturn was the god of agriculture, wealth, and time. In Greek mythology, he was known as Cronus. He was associated with the Golden Age and was overthrown by his son Jupiter",
      symbolism:
        "Symbol of time, harvest, and the cyclical nature of life. The planet's rings have been interpreted as symbols of cosmic order and beauty",
      scienceFiction:
        "Often depicted in science fiction with its iconic rings, from classic literature to modern films",
      scientificSignificance:
        "Studying Saturn's rings helps scientists understand disk formation around stars and planets",
    },
  },
  {
    name: "Uranus",
    ...
    description:
      "Uranus is the seventh planet from the Sun and the first of the ice giants, a category of planets distinct from the gas giants Jupiter and Saturn. This distant world is unique among planets as it rotates on its side, with an axial tilt of 98 degrees, likely caused by a massive collision with an Earth-sized object early in its history. This extreme tilt gives Uranus the most extreme seasons in the solar system, with each pole experiencing 42 years of continuous sunlight followed by 42 years of darkness. Uranus has a pale blue-green color due to methane gas in its atmosphere, which absorbs red light and reflects blue-green light. The planet has 27 known moons, all named after characters from the works of William Shakespeare and Alexander Pope. Uranus also has 13 faint rings, discovered in 1977, which are much darker and less prominent than Saturn's spectacular ring system. The planet's magnetic field is tilted 60 degrees from its rotation axis, creating a complex magnetosphere that scientists are still studying.",
    facts: [
    ...
    atmosphere: {
      composition:
        "Hydrogen (83%), Helium (15%), Methane (2.3%), with traces of other hydrocarbons",
      pressure: "No solid surface, pressure increases with depth",
      layers: "Upper atmosphere, troposphere, stratosphere, thermosphere",
    ...
    surface: {
      features:
        "Bland appearance with few visible features, faint rings, no solid surface",
      temperature: "-224°C (cloud top level)",
      storms:
        "Occasional storms and cloud features, but much less active than Jupiter or Saturn",
    ...
    internalStructure: {
      ...
      details:
        "Unlike Jupiter and Saturn, Uranus has more ice and less hydrogen in its composition",
      magneticField:
        "Tilted magnetic field suggesting the core may be offset from the planet's center",
    },
    exploration: {
      missions: ["Voyager 2"],
      discoveries:
        "Tilted magnetic field, complex ring system, extreme axial tilt, cold atmosphere",
      futureMissions: "Proposed missions to study Uranus and Neptune in detail",
    },
    culturalImpact: {
      ancientCultures:
        "Named after the Greek god of the sky, Uranus was the father of Saturn and grandfather of Jupiter in Roman mythology",
      mythology:
        "In Greek mythology, Uranus was the primordial god of the sky, husband of Gaia (Earth) and father of the Titans. He was castrated and overthrown by his son Cronus (Saturn)",
      symbolism:
        "Associated with the heavens, innovation, and the cosmic order. Its discovery in 1781 marked the first planet found with a telescope",
      scienceFiction:
        "Less frequently featured in science fiction due to its distance and bland appearance",
      scientificSignificance:
        "Studying Uranus helps scientists understand ice giant formation and planetary evolution",
    },
  },
  {
    name: "Neptune",
    ...
    atmosphere: {
      composition:
        "Hydrogen (80%), Helium (19%), Methane (1.5%), with traces of other hydrocarbons",
      pressure: "No solid surface, pressure increases with depth",
      layers: "Upper atmosphere, troposphere, stratosphere, thermosphere",
    ...
    surface: {
      features:
        "Great Dark Spot, high-speed winds, faint rings, no solid surface",
      temperature: "-220°C (cloud top level)",
      storms:
        "Great Dark Spot and other storm systems, but less prominent than Jupiter's",
      cloudLayers: "Multiple cloud layers including methane ice clouds",
    },
    internalStructure: {
      core: "Rocky core, surrounded by icy mantle (water, ammonia, methane), then gaseous atmosphere",
      details:
        "Similar structure to Uranus but more active, with stronger winds and more dynamic weather",
      magneticField:
        "Tilted magnetic field similar to Uranus, suggesting similar internal structure",
    },
    exploration: {
      missions: ["Voyager 2"],
      discoveries:
        "Great Dark Spot, powerful winds, complex ring system, retrograde moon Triton",
      futureMissions:
        "Proposed missions to study Neptune and its moons in detail",
    },
    culturalImpact: {
      ancientCultures:
        "Named after the Roman god of the sea, Neptune was not known to ancient civilizations as it's too faint to see with the naked eye",
      mythology:
        "In Roman mythology, Neptune was the god of the sea, earthquakes, and horses. In Greek mythology, he was known as Poseidon. He was one of the three brothers who ruled the world (Jupiter-sky, Pluto-underworld, Neptune-sea)",
      symbolism:
        "Associated with the deep sea, mystery, and exploration. Its blue color and discovery through mathematics symbolize the power of human intellect",
      scienceFiction:
        "Sometimes featured in science fiction as a mysterious, distant world",
      scientificSignificance:
        "Studying Neptune helps scientists understand the outer solar system and ice giant formation",
    },
  },
];
